...
|----|-------------|--------|--------|-----------------|
| A-3 | 初期手札上限 | [constants.md#手札関連](./constants.md#手札関連) | ドロー率、カード期待出現間隔 | カード使用率 |
...
| ID | パラメータ名 | 参照先 | 影響先 | 体験指標への影響 |
|----|-------------|--------|--------|-----------------|
| D-1 | ファイアボルトダメージ | [constants.md#ダメージ](./constants.md#ダメージ) | キルターン数 | 1階層あたり所要時間 |
| D-2 | サンダーダメージ | [constants.md#ダメージ](./constants.md#ダメージ) | キルターン数 | ボス戦所要時間 |
| D-5 | 移動距離 | [constants.md#移動](./constants.md#移動) | 1ターン移動量 | 1階層あたり所要時間 |
| D-6 | ジャンプ着地距離 | [constants.md#移動](./constants.md#移動) | 1ターン移動量、回避能力 | 1階層あたり所要時間 |
...
| J-2 | 宝箱ドロップ（出現率・レアリティ・中身） | [constants.md#宝箱ドロップ](./constants.md#宝箱ドロップ) | HP回復効率、デッキ構築 | 到達階層 |
...
- [ ] 回復手段（宝箱、休憩所）の回復量とバランスが取れているか
- [ ] 到達階層分布が目標（初心者3〜5F、中級者8〜12F）と合致するか

### 敵HPを変更したら

- [ ] ファイアボルトダメージとの比率を確認（キルターン数が妥当か）
- [ ] サンダーの相対価値が変わっていないか
